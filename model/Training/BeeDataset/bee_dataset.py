...
Author: Anushri Rawat <rawatanushri2002@gmail.com>
"""

_CITATION = """
@misc{BeeCognition - A camera based bee-hive monitoring,
  title =   "Dataset for a camera based bee-hive monitoring",
  url={https://github.com/Anushri-Rawat}, journal={BeeCognition},
  author =  "Anushri Rawat",
  year   =  "2024",
  NOTE   = "\\url{https://raspbee.de/} and \\url{https://github.com/Anushri-Rawat/BeeCognition}"
}
"""
...
class BeeDataset(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    t_shape = (self.builder_config.height,
